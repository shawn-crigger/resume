...
?>
        <div class="row clearfix">
            ...
            <div class="large-2 medium-2 columns">
                ...
                <ul class="vcard">
                    <li class="fn">Shawn Crigger
                    </li>
                    <li class="street-address">2400 Douglas St.
                    </li>
                    <li class="locality">North Myrtle Beach
                    </li>
                    <li>
                        <span class="state">South Carolina</span>, <span class="zip">29582</span>
                    </li>
                    <li class="email">
                        <a href="#">ithippyshawn@</a>
                    </li>
                </ul>
            </div><!--
      <div class="large-4 medium-4 columns">
  ...
  -->
        ...
        <div class="row">
            <div class="large-4 medium-4 columns">
                ...
                <ul class="ranking">
                    <li>PHP<span class="star-5">* * * * *</span>
                    </li>
                    <li>JavaScript<span class="star-5">* * * * *</span>
                    </li>
                    <li>CSS3<span class="star-4">* * * *</span>
                    </li>
                    <li>HTML5<span class="star-4">* * * *</span>
                    </li>
                    <li>XHTML<span class="star-3">* * *</span>
                    </li>
                    <li>Servers<span class="star-4">* * * *</span>
                    </li>
                </ul>
            </div>
